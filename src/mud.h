...
typedef enum {
  ...
  STYLE_FLOWING,
  STYLE_UPWARD_SPIKE,
  STYLE_LONG_UPWARD_SPIKE,
  STYLE_ALL_SPIKE,
  STYLE_UP_SPIKE_ONE_FACE,
  STYLE_ERATIC_SPIKES,
  STYLE_SHORT_PONYTAIL,
  STYLE_MEDIUM_PONYTAIL,
  STYLE_LONG_PONYTAIL,
...
typedef enum {
  ...
  CON_GET_NEW_EYE,
  CON_GET_NEW_BUILD,
  CON_GET_NEW_COMPLEXION,
  CON_GET_NEW_SECONDARYCOLOR,
  CON_COPYOVER_RECOVER,
  CON_GET_HC,
  CON_GET_LAST_NAME,
  CON_CONFIRM_LAST_NAME,
  CON_PLAYING = 0,
  CON_NOTE_TO,
  CON_NOTE_SUBJECT,
  CON_NOTE_EXPIRE,
...
#define VALID_LANGS (LANG_COMMON | LANG_SAIYAN | LANG_HALFBREED | LANG_NAMEK | LANG_ANDROID | LANG_ICER | LANG_BIO_ANDROID | LANG_KAIO | LANG_DEMON | LANG_WIZARD)
/* 18 Languages */
...
#define GET_HITROLL(ch) ((ch)->hitroll + (2 - (abs((ch)->mental_state) / 10)))
