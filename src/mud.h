 ...
 */
#define PREFIX_DIR      "/var/dbns" /* prefix where the information is stored and installed to */
...
#define PLAYFROM_DIR	PREFIX_DIR "/playfrom/"	/* To track character login sites */
/*
...
#define CHAT_FILE	PREFIX_DIR "/chat/chat.data"
