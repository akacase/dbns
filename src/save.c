...
void
fixTransStatAffects (CHAR_DATA * ch)
{
     AFFECT_DATA *tAff;
     ...
     for (obj = ch->first_carrying; obj; obj = obj->next_content)
	  if (obj->wear_loc > -1 && obj->wear_loc < MAX_WEAR) {
	       if (ch->exp >= obj->level) {
		    ...
		    sprintf (buf,
		      "%s had on %s:  ch->exp = %.0Lf  obj->level = %.0Lf",
		      ch->name, obj->name, ch->exp, obj->level);
		    bug (buf, 0);
	       }
	       unequip_char (ch, obj);
	  }
...
fwrite_char (CHAR_DATA * ch, FILE * fp)
{
	 ...
	 fprintf (fp, "DCD           %d\n", ch->skilldcd);
	 fprintf (fp, "Defensive_Style           %d\n", ch->skilldefensive_style);
	 fprintf (fp, "Dodge           %d\n", ch->skilldodge);
	 fprintf (fp, "Evasive_Style           %d\n", ch->skillevasive_style);
	 fprintf (fp, "Lariat           %d\n", ch->skilllariat);
	 fprintf (fp, "Punch           %d\n", ch->skillpunch);
	 fprintf (fp, "Meditate           %d\n", ch->skillmeditate);
	 fprintf (fp, "Standard_Style           %d\n", ch->skillstandard_style);
	 fprintf (fp, "SSJ1           %d\n", ch->skillssj1);
	 fprintf (fp, "SSJ2           %d\n", ch->skillssj2);
	 fprintf (fp, "SSJ3           %d\n", ch->skillssj3);
	 fprintf (fp, "SSGOD           %d\n", ch->skillssgod);
	 fprintf (fp, "SSBLUE           %d\n", ch->skillssblue);
	 fprintf (fp, "Ultra_Instinct           %d\n", ch->skillultra_instinct);
	 fprintf (fp, "BBK           %d\n", ch->skillbbk);
	 fprintf (fp, "Burning_Attack           %d\n", ch->skillburning_attack);
	 fprintf (fp, "Concentrated_Beam           %d\n", ch->skillconcentrated_beam);
	 fprintf (fp, "Blast_Zone           %d\n", ch->skillblast_zone);
	 fprintf (fp, "Crusherball           %d\n", ch->skillcrusherball);
	 fprintf (fp, "Death_Ball           %d\n", ch->skilldeath_ball);
	 fprintf (fp, "Destructo_Disc           %d\n", ch->skilldestructo_disc);
	 fprintf (fp, "Ecliptic_Meteor           %d\n", ch->skillecliptic_meteor);
	 fprintf (fp, "Energy_Ball           %d\n", ch->skillenergy_ball);
	 fprintf (fp, "Energy_Beam           %d\n", ch->skillenergy_beam);
	 fprintf (fp, "Energy_Disc           %d\n", ch->skillenergy_disc);
	 fprintf (fp, "Final_Flash           %d\n", ch->skillfinal_flash);
	 fprintf (fp, "Finger_Beam           %d\n", ch->skillfinger_beam);
	 fprintf (fp, "Forcewave           %d\n", ch->skillforcewave);
	 fprintf (fp, "Gallic_Gun           %d\n", ch->skillgallic_gun);
	 fprintf (fp, "Finishing_Buster           %d\n", ch->skillfinishing_buster);
	 fprintf (fp, "Gigantic_Meteor           %d\n", ch->skillgigantic_meteor);
	 fprintf (fp, "Heaven_Splitter           %d\n", ch->skillheaven_splitter);
	 fprintf (fp, "Hells_Flash           %d\n", ch->skillhells_flash);
	 ...
	 fprintf (fp, "Makosen           %d\n", ch->skillmakosen);
	 fprintf (fp, "Masenko           %d\n", ch->skillmasenko);
	 fprintf (fp, "Meteor           %d\n", ch->skillmeteor);
	 fprintf (fp, "Multidisc           %d\n", ch->skillmultidisc);
	 fprintf (fp, "Multi_Eye_Beam           %d\n", ch->skillmulti_eye_beam);
	 fprintf (fp, "Oozaru_Mouth_Cannon           %d\n", ch->skillmonkey_cannon);
	 fprintf (fp, "Psionic_Blast           %d\n", ch->skillpsionic_blast);
	 fprintf (fp, "Multi_Finger_Beam           %d\n", ch->skillmulti_finger_beam);
	 fprintf (fp, "Sense          %d\n", ch->skillsense);
	 fprintf (fp, "Shockwave           %d\n", ch->skillshockwave);
	 fprintf (fp, "Special_Beam_Cannon           %d\n", ch->skillsbc);
	 fprintf (fp, "Spirit_Ball           %d\n", ch->skillspirit_ball);
	 fprintf (fp, "Spirit_Bomb           %d\n", ch->skillspirit_bomb);
	 fprintf (fp, "SkillSuppress           %d\n", ch->skillsuppress);
	 fprintf (fp, "School               %d\n", ch->school);
     ...
     */
     ...
     fprintf (fp, "PermTStats     %d %d %d %d\n",
       ch->pcdata->permTstr,
       ch->pcdata->permTint, ch->pcdata->permTspd, ch->pcdata->permTcon);
     fprintf (fp, "AttrTrain      %d %d %d %d\n",
       ch->pcdata->tStr,
       ch->pcdata->tInt, ch->pcdata->tSpd, ch->pcdata->tCon);
     ...
     */
     fprintf (fp, "Condition      %d %d %d %d\n",
       ...
       ch->pcdata->condition[2], ch->pcdata->condition[2]);
     if (ch->race == 6) {
	  fprintf (fp, "Absorb_Race    %d %d %d %d %d %d %d\n",
	    ...
	    ch->pcdata->absorb_race[5], ch->pcdata->absorb_race[6]);
     ...
     for (paf = ch->first_affect; paf; paf = paf->next) {
	  ...
	  if (paf->type >= 0 && paf->type < TYPE_PERSONAL)
		 ...
		 paf->modifier,
		 paf->location,
		 paf->affLocator, print_bitvector (&paf->bitvector));
	  else
...
fread_char (CHAR_DATA * ch, FILE * fp, bool preload)
{
     ...
     for (;;) {
	       ...
	       if (!strcmp (word, "Ability")) {
		    ...
		    if (preload)
			 ...
			 if (file_ver < 3)
			      ...
			      sn =
				bsearch_skill_exact (fread_word (fp), gsn_first_ability,
				  gsn_first_weapon - 1);
			 if (sn < 0)
	  ...
	  case 'C':
	       ...
	       KEY ("ClanZeniDon", ch->pcdata->clanZeniDonated,
		 fread_number_skill (fp));
	       KEY ("ClanZeniTax", ch->pcdata->clanZeniClanTax,
		 fread_number_skill (fp));
	  ...
	  case 'M':
		   ...
		   KEY ("Masteryenergy_ball", ch->masteryenergy_ball, fread_number (fp));
		   KEY ("Masterycrusherball", ch->masterycrusherball, fread_number (fp));
		   KEY ("Masterymeteor", ch->masterymeteor, fread_number (fp));
		   KEY ("Masterygigantic_meteor", ch->masterygigantic_meteor, fread_number (fp));
		   KEY ("Masteryecliptic_meteor", ch->masteryecliptic_meteor, fread_number (fp));
		   KEY ("Masterydeath_ball", ch->masterydeath_ball, fread_number (fp));
		   KEY ("Masteryenergybeam", ch->masteryenergybeam, fread_number (fp));
		   KEY ("Masteryeye_beam", ch->masteryeye_beam, fread_number (fp));
		   KEY ("Masterymasenko", ch->masterymasenko, fread_number (fp));
		   KEY ("Masterymakosen", ch->masterymakosen, fread_number (fp));
		   KEY ("Masterysbc", ch->masterysbc, fread_number (fp));
		   KEY ("Masteryconcentrated_beam", ch->masteryconcentrated_beam, fread_number (fp));
		   KEY ("Masterykamehameha", ch->masterykamehameha, fread_number (fp));
		   KEY ("Masterygallic_gun", ch->masterygallic_gun, fread_number (fp));
		   KEY ("Masteryfinger_beam", ch->masteryfinger_beam, fread_number (fp));
		   KEY ("Masterydestructo_disc", ch->masterydestructo_disc, fread_number (fp));
		   KEY ("Masterydestructive_wave", ch->masterydestructive_wave, fread_number (fp));
		   KEY ("Masteryforcewave", ch->masteryforcewave, fread_number (fp));
		   KEY ("Masteryshockwave", ch->masteryshockwave, fread_number (fp));
		   KEY ("Masteryenergy_disc", ch->masteryenergy_disc, fread_number (fp));
		   KEY ("Masterypunch", ch->masterypunch, fread_number (fp));
		   KEY ("Masteryhaymaker", ch->masteryhaymaker, fread_number (fp));
	  ...
	  case 'T':
	       ...
	       if (!strcmp (word, "Tongue")) {
		    ...
		    if (preload)
			 ...
			 sn =
			   bsearch_skill_exact (fread_word (fp), gsn_first_tongue,
			     gsn_top_sn - 1);
			 if (sn < 0)
	       ...
	       if (!strcmp (word, "End")) {
		    if (!fNest || !fVnum) {
			 ...
			 if ((!IS_OBJ_STAT (obj, ITEM_RARE)
			     && !IS_OBJ_STAT (obj, ITEM_UNIQUE)) || IS_NPC (ch)) {
