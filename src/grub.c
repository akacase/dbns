 ...
 */
void 
do_opfind(CHAR_DATA * ch, char *argument)
{					/* Gorog */
	OBJ_INDEX_DATA *pObj;
	MPROG_DATA *pProg;
 ...
 */
void 
do_mpfind(CHAR_DATA * ch, char *argument)
{					/* Gorog */
	MOB_INDEX_DATA *pMob;
	MPROG_DATA *pProg;
	char arg1[MAX_INPUT_LENGTH];
 ...
 */
void 
do_rpfind(CHAR_DATA * ch, char *argument)
{					/* Gorog */
...
short 
go_wear_ext(long arg)
{					/* extract bit set in arg ignoring pos
					 * 1 */
	short cou;
