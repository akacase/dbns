...
void boot_db() {
   ...
   */
  {
    ...
    load_colors();
    log_string(
        "Loading Housing System, Home Accessories Data,"
...
void make_wizlist() {
  ...
  for (wiz = first_wiz; wiz; wiz = wiz->next) {
    if (wiz->level < ilevel) {
      ...
      switch (ilevel) {
        case MAX_LEVEL - 0:
          towizfile(" Supreme Kai");
          break;
        case MAX_LEVEL - 1:
          towizfile(" Grand Kais");
          break;
        case MAX_LEVEL - 2:
          towizfile(" Coders");
          break;
        ...
        case MAX_LEVEL - 6:
          ...
          break;
        case MAX_LEVEL - 7:
          towizfile(" Assistant Head Enforcers and Advanced Builders");
          break;
        case MAX_LEVEL - 8:
          towizfile(" Admin Builders");
          break;
        case MAX_LEVEL - 9:
          towizfile(" Admin Builders");
          break;
...
MPROG_DATA *
mprog_file_read(char *f, MPROG_DATA *mprg,
                MOB_INDEX_DATA *pMobIndex) {
...
MPROG_DATA *
oprog_file_read(char *f, MPROG_DATA *mprg,
                OBJ_INDEX_DATA *pObjIndex) {
  char MUDProgfile[MAX_INPUT_LENGTH];
  FILE *progfile;
  char letter;
...
/* This routine reads in scripts of OBJprograms from a file */
MPROG_DATA *
rprog_file_read(char *f, MPROG_DATA *mprg,
 ...
 */
EXIT_DATA *
make_exit(ROOM_INDEX_DATA *pRoomIndex, ROOM_INDEX_DATA *to_room, sh_int door) {
...
#if !defined(READ_AREA) /* Dont always want to read stuff.. \
                         * dunno.. shrug */
