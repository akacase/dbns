...
void
fread_pfile(FILE *fp, time_t tdiff, char *fname)
{
	char   *word;
	char   *name = NULL;
	sh_int 	level = 0;
...
void
read_pfile(char *dirname, char *filename)
{
	FILE   *fp;
...
void 
do_pfiles(CHAR_DATA * ch, char *argument)
{
	if (IS_NPC(ch)) {
