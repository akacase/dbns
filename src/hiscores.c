      ...
      if (table->vnum == -1) {
        ...
        for (entry = table->first_entry; entry; entry = entry->next) {
          if (!strcmp(entry->name, capitalize(argument))) {
            ...
            if (!strcmp(table->keyword, "powerlevel") || !strcmp(table->keyword, "plsaiyan") || !strcmp(table->keyword, "plhuman") || !strcmp(table->keyword, "plhalfbreed") || !strcmp(table->keyword, "plnamek") || !strcmp(table->keyword, "plandroid") || !strcmp(table->keyword, "plkaio") || !strcmp(table->keyword, "pldemon") || !strcmp(table->keyword, "plicer") || !strcmp(table->keyword, "plbio-android") || !strcmp(table->keyword, "januaryladder") || !strcmp(table->keyword, "februaryladder") || !strcmp(table->keyword, "marchladder") || !strcmp(table->keyword, "aprilladder") || !strcmp(table->keyword, "mayladder") || !strcmp(table->keyword, "juneladder") || !strcmp(table->keyword, "julyladder") || !strcmp(table->keyword, "augustladder") || !strcmp(table->keyword, "septemberladder") || !strcmp(table->keyword, "octoberladder") || !strcmp(table->keyword, "novemberladder") || !strcmp(table->keyword, "decemberladder"))
