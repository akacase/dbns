...
void 
add_dns(char *dhost, char *address)
{
	DNS_DATA *cache;
...
process_dns(DESCRIPTOR_DATA * d)
{
	...
	/*
	 * we don't have to check here, cos the child is probably dead
	 * already. (but out of safety we do)
	 * 
...
void 
do_cache(CHAR_DATA * ch, char *argument)
{
	DNS_DATA *cache;
	int ip = 0;
